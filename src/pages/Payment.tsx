...
const Payment: React.FC = () => {
  ...
  return (
    <div className='p-3 pb-10 border-b'>
      <form ref={formRef}  autoComplete='false' action='#' className='max-w-[1180px] mx-auto md:grid md:grid-cols-2 gap-x-8'>
        <div>
          ...
          <div>
            ...
            <div className='mt-3 grid grid-cols-2 mt-3'>
              <div
                style={{ marginRight: '1em' }}
                className='mt-3 grid grid-cols-1 mt-3'
              >
                <label
                  htmlFor='phone'
                  className='block mb-1 text-sm text-gray-900'
